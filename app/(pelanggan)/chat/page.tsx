                ...
                <Card className="border-slate-100 hover:border-blue-100 hover:shadow-sm transition-all rounded-2xl bg-white cursor-pointer group">
                  <CardContent className="p-5 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                      <div className="h-12 w-12 rounded-full bg-blue-50 text-blue-900 font-bold flex items-center justify-center text-sm shadow-sm shrink-0">
                        {teknisiName.slice(0, 2).toUpperCase()}
                      </div>
                      <div className="space-y-1">
                        <h3 className="font-bold text-slate-800 text-sm font-heading group-hover:text-blue-900 transition-colors">
                          {teknisiName}
                        </h3>
